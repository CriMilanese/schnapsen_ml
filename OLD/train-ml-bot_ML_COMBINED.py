...
player_1 = ml.Bot(model_file='bots/ml/model_KBBOT.pkl')
player_2 = ml.Bot(model_file='bots/ml/model_RDEEP.pkl')
# player = rdeep.Bot()
...
joblib.dump(model, './bots/ml/model_ML_COMBINED_KBBOT_RDEEP.pkl')
