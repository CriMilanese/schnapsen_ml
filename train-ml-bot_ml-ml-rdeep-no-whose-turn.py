...
from bots.ml_ml_rdeep import ml_ml_rdeep
# from bots.rdeep import rdeep

from bots.ml_no_whose_turn.ml_no_whose_turn import features
...
if options.create_dataset or not os.path.isfile(options.path):
    create_dataset(options.path, player=ml_ml_rdeep.Bot(), games=10000)
...
if options.train:
    ...
    joblib.dump(model, './bots/ml_no_whose_turn/model_ml_ml_rdeep_no_whose_turn.pkl')
