...
DEFAULT_MODEL = os.path.dirname(os.path.realpath(__file__)) + '/model_ml_fine_tuned_feat.pkl'
...
def features(state):
    ...
    # Add normalized number of trump cards
    feature_set.append(num_trump_cards/5)

    # Append one-hot encoded game-points
    game_points_vector = [0,0,0]
    for i in range(0,game_points):
        game_points_vector[i] = 1
    feature_set += game_points_vector
